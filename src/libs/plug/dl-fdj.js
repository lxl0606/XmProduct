...
window.addEventListener('load', function () {
    ...
    (function () {
        ...
        var imgArr = {
            'big': [
                '../img/gdImg/dl-fdj1.jpg',
                '../img/gdImg/dl-fdj2.jpg',
                '../img/gdImg/dl-fdj3.jpg',
                '../img/gdImg/dl-fdj4.jpg',
                '../img/gdImg/dl-fdj5.jpg',
                // '../img/gdImg/dl-fdj1.jpg',
                
            ],
            'small': [
                '../img/gdImg/sm-fdj1.jpg',
                '../img/gdImg/sm-fdj2.jpg',
                '../img/gdImg/sm-fdj3.jpg',
                '../img/gdImg/sm-fdj4.jpg',
                '../img/gdImg/sm-fdj5.jpg',
                // '../img/gdImg/sm-fdj1.jpg',
